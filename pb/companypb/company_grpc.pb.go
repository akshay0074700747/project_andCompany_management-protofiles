...
const (
	...
	CompanyService_ToggleIsPayed_FullMethodName                   = "/company.CompanyService/ToggleIsPayed"
)
...
type CompanyServiceClient interface {
	...
	GetScheduledInterviewsofUser(ctx context.Context, in *GetScheduledInterviewsofUserReq, opts ...grpc.CallOption) (CompanyService_GetScheduledInterviewsofUserClient, error)
	...
	ToggleIsPayed(ctx context.Context, in *ToggleIsPayedReq, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *companyServiceClient) GetScheduledInterviewsofUser(ctx context.Context, in *GetScheduledInterviewsofUserReq, opts ...grpc.CallOption) (CompanyService_GetScheduledInterviewsofUserClient, error) {
	stream, err := c.cc.NewStream(ctx, &CompanyService_ServiceDesc.Streams[17], CompanyService_GetScheduledInterviewsofUser_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &companyServiceGetScheduledInterviewsofUserClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type CompanyService_GetScheduledInterviewsofUserClient interface {
	Recv() (*GetScheduledInterviewsofUserRes, error)
	grpc.ClientStream
}

type companyServiceGetScheduledInterviewsofUserClient struct {
	grpc.ClientStream
}

func (x *companyServiceGetScheduledInterviewsofUserClient) Recv() (*GetScheduledInterviewsofUserRes, error) {
	m := new(GetScheduledInterviewsofUserRes)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *companyServiceClient) GetShortlistedApplications(ctx context.Context, in *GetShortlistedApplicationsReq, opts ...grpc.CallOption) (CompanyService_GetShortlistedApplicationsClient, error) {
	stream, err := c.cc.NewStream(ctx, &CompanyService_ServiceDesc.Streams[18], CompanyService_GetShortlistedApplications_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *companyServiceClient) GetJobs(ctx context.Context, in *GetJobsReq, opts ...grpc.CallOption) (CompanyService_GetJobsClient, error) {
	stream, err := c.cc.NewStream(ctx, &CompanyService_ServiceDesc.Streams[19], CompanyService_GetJobs_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *companyServiceClient) GetAllJobApplicationsofUser(ctx context.Context, in *GetAllJobApplicationsofUserReq, opts ...grpc.CallOption) (CompanyService_GetAllJobApplicationsofUserClient, error) {
	stream, err := c.cc.NewStream(ctx, &CompanyService_ServiceDesc.Streams[20], CompanyService_GetAllJobApplicationsofUser_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &companyServiceGetAllJobApplicationsofUserClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type CompanyService_GetAllJobApplicationsofUserClient interface {
	Recv() (*GetAllJobApplicationsofUserRes, error)
	grpc.ClientStream
}

type companyServiceGetAllJobApplicationsofUserClient struct {
	grpc.ClientStream
}

func (x *companyServiceGetAllJobApplicationsofUserClient) Recv() (*GetAllJobApplicationsofUserRes, error) {
	m := new(GetAllJobApplicationsofUserRes)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
func (c *companyServiceClient) ToggleIsPayed(ctx context.Context, in *ToggleIsPayedReq, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, CompanyService_ToggleIsPayed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CompanyServiceServer interface {
	...
	GetScheduledInterviewsofUser(*GetScheduledInterviewsofUserReq, CompanyService_GetScheduledInterviewsofUserServer) error
	...
	ToggleIsPayed(context.Context, *ToggleIsPayedReq) (*empty.Empty, error)
...
func (UnimplementedCompanyServiceServer) GetScheduledInterviewsofUser(*GetScheduledInterviewsofUserReq, CompanyService_GetScheduledInterviewsofUserServer) error {
	return status.Errorf(codes.Unimplemented, "method GetScheduledInterviewsofUser not implemented")
}
...
func (UnimplementedCompanyServiceServer) ToggleIsPayed(context.Context, *ToggleIsPayedReq) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ToggleIsPayed not implemented")
}
...
func _CompanyService_GetScheduledInterviewsofUser_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetScheduledInterviewsofUserReq)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CompanyServiceServer).GetScheduledInterviewsofUser(m, &companyServiceGetScheduledInterviewsofUserServer{stream})
}

type CompanyService_GetScheduledInterviewsofUserServer interface {
	Send(*GetScheduledInterviewsofUserRes) error
	grpc.ServerStream
}

type companyServiceGetScheduledInterviewsofUserServer struct {
	grpc.ServerStream
}

func (x *companyServiceGetScheduledInterviewsofUserServer) Send(m *GetScheduledInterviewsofUserRes) error {
	return x.ServerStream.SendMsg(m)
}
...
func _CompanyService_GetAllJobApplicationsofUser_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetAllJobApplicationsofUserReq)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(CompanyServiceServer).GetAllJobApplicationsofUser(m, &companyServiceGetAllJobApplicationsofUserServer{stream})
}

type CompanyService_GetAllJobApplicationsofUserServer interface {
	Send(*GetAllJobApplicationsofUserRes) error
	grpc.ServerStream
}

type companyServiceGetAllJobApplicationsofUserServer struct {
	grpc.ServerStream
}

func (x *companyServiceGetAllJobApplicationsofUserServer) Send(m *GetAllJobApplicationsofUserRes) error {
	return x.ServerStream.SendMsg(m)
}
...
func _CompanyService_ToggleIsPayed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ToggleIsPayedReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CompanyServiceServer).ToggleIsPayed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CompanyService_ToggleIsPayed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CompanyServiceServer).ToggleIsPayed(ctx, req.(*ToggleIsPayedReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CompanyService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ToggleIsPayed",
			Handler:    _CompanyService_ToggleIsPayed_Handler,
		},
	},
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "GetScheduledInterviewsofUser",
