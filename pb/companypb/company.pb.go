...
var file_company_proto_rawDesc = []byte{
	...
	0x05, 0x56, 0x69, 0x65, 0x77, 0x73, 0x22, 0xa2, 0x01, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x43,
	...
	0x6d, 0x65, 0x22, 0x23, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x12, 0x0e, 0x0a, 0x02, 0x49, 0x44, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x02, 0x49, 0x44, 0x22, 0x33, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x50, 0x65,
	0x72, 0x6d, 0x69, 0x73, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x12, 0x1e, 0x0a, 0x0a,
	0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0a, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x32, 0xbb, 0x0e, 0x0a,
	...
	0x56, 0x69, 0x65, 0x77, 0x73, 0x52, 0x65, 0x73, 0x12, 0x44, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74,
	...
	0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x69, 0x65, 0x73, 0x52, 0x65, 0x73, 0x30, 0x01, 0x12, 0x41,
	...
	0x69, 0x73, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f,
...
var file_company_proto_msgTypes = make([]protoimpl.MessageInfo, 36)
var file_company_proto_goTypes = []interface{}{
	...
	(*ListCompaniesRes)(nil),                   // 31: company.ListCompaniesRes
	(*GetVisitorsReq)(nil),                     // 32: company.GetVisitorsReq
	(*GetVisitorsRes)(nil),                     // 33: company.GetVisitorsRes
	(*GetPermisssionReq)(nil),                  // 34: company.GetPermisssionReq
	(*GetPermisssionRes)(nil),                  // 35: company.GetPermisssionRes
...
var file_company_proto_depIdxs = []int32{
	...
	36, // 3: company.GetProfileViewsReq.From:type_name -> google.protobuf.Timestamp
	36, // 4: company.GetProfileViewsReq.To:type_name -> google.protobuf.Timestamp
	36, // 5: company.GetVisitorsReq.From:type_name -> google.protobuf.Timestamp
	36, // 6: company.GetVisitorsReq.To:type_name -> google.protobuf.Timestamp
	36, // 7: company.GetVisitorsRes.VisitedTime:type_name -> google.protobuf.Timestamp
	1,  // 8: company.CompanyService.RegisterCompany:input_type -> company.RegisterCompanyRequest
	37, // 9: company.CompanyService.GetCompanyTypes:input_type -> google.protobuf.Empty
	37, // 10: company.CompanyService.GetPermissions:input_type -> google.protobuf.Empty
	...
	37, // 28: company.CompanyService.ListCompanies:input_type -> google.protobuf.Empty
	32, // 29: company.CompanyService.GetVisitors:input_type -> company.GetVisitorsReq
	34, // 30: company.CompanyService.GetPermission:input_type -> company.GetPermisssionReq
	3,  // 31: company.CompanyService.RegisterCompany:output_type -> company.CompanyResponce
	2,  // 32: company.CompanyService.GetCompanyTypes:output_type -> company.GetCompanyTypesRes
	4,  // 33: company.CompanyService.GetPermissions:output_type -> company.Permission
	37, // 34: company.CompanyService.AddEmployees:output_type -> google.protobuf.Empty
	37, // 35: company.CompanyService.AttachRoleWithPermisssions:output_type -> google.protobuf.Empty
	8,  // 36: company.CompanyService.GetAttachedRoleswithPermissions:output_type -> company.GetAttachedRoleswithPermissionsRes
	37, // 37: company.CompanyService.AddCompanyTypes:output_type -> google.protobuf.Empty
	37, // 38: company.CompanyService.Permissions:output_type -> google.protobuf.Empty
	12, // 39: company.CompanyService.GetCompanyDetails:output_type -> company.GetCompanyDetailsRes
	13, // 40: company.CompanyService.GetCompanyEmployees:output_type -> company.GetCompanyEmployeesRes
	15, // 41: company.CompanyService.LogintoCompany:output_type -> company.LogintoCompanyRes
	37, // 42: company.CompanyService.AddMemberStatus:output_type -> google.protobuf.Empty
	19, // 43: company.CompanyService.GetEmployeesLeaderBoard:output_type -> company.GetEmployeesLeaderBoardRes
	37, // 44: company.CompanyService.SalaryIncrementofEmployee:output_type -> google.protobuf.Empty
	37, // 45: company.CompanyService.SalaryIncrementofRole:output_type -> google.protobuf.Empty
	23, // 46: company.CompanyService.GetAverageSalaryperRole:output_type -> company.GetAverageSalaryperRoleRes
	25, // 47: company.CompanyService.GetSalaryLeaderboard:output_type -> company.GetSalaryLeaderboardRes
	37, // 48: company.CompanyService.RaiseProblem:output_type -> google.protobuf.Empty
	28, // 49: company.CompanyService.GetProblems:output_type -> company.GetProblemsRes
	30, // 50: company.CompanyService.GetProfileViews:output_type -> company.GetProfileViewsRes
	31, // 51: company.CompanyService.ListCompanies:output_type -> company.ListCompaniesRes
	33, // 52: company.CompanyService.GetVisitors:output_type -> company.GetVisitorsRes
	35, // 53: company.CompanyService.GetPermission:output_type -> company.GetPermisssionRes
