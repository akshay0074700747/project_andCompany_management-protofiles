...
var file_company_proto_rawDesc = []byte{
	...
	0x49, 0x44, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x49, 0x44, 0x22, 0x29, 0x0a, 0x0f,
	...
	0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x32, 0x8c, 0x08, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x70,
	...
	0x65, 0x73, 0x12, 0x4d, 0x0a, 0x0f, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x43, 0x6f, 0x6d, 0x70,
	0x61, 0x6e, 0x69, 0x65, 0x73, 0x12, 0x19, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x2e,
	0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x52, 0x65, 0x71,
	0x1a, 0x1d, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x6f,
	0x6d, 0x70, 0x61, 0x6e, 0x79, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x52, 0x65, 0x73, 0x30,
	0x01, 0x12, 0x43, 0x0a, 0x0f, 0x41, 0x64, 0x64, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x53, 0x74,
	...
	0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x70, 0x62, 0x2f, 0x63,
...
var file_company_proto_depIdxs = []int32{
	...
	18, // 4: company.CompanyService.GetCompanyTypes:input_type -> google.protobuf.Empty
	18, // 5: company.CompanyService.GetPermissions:input_type -> google.protobuf.Empty
	...
	3,  // 16: company.CompanyService.RegisterCompany:output_type -> company.CompanyResponce
	2,  // 17: company.CompanyService.GetCompanyTypes:output_type -> company.GetCompanyTypesRes
	4,  // 18: company.CompanyService.GetPermissions:output_type -> company.Permission
	18, // 19: company.CompanyService.AddEmployees:output_type -> google.protobuf.Empty
	18, // 20: company.CompanyService.AttachRoleWithPermisssions:output_type -> google.protobuf.Empty
	8,  // 21: company.CompanyService.GetAttachedRoleswithPermissions:output_type -> company.GetAttachedRoleswithPermissionsRes
	18, // 22: company.CompanyService.AddCompanyTypes:output_type -> google.protobuf.Empty
	18, // 23: company.CompanyService.Permissions:output_type -> google.protobuf.Empty
	12, // 24: company.CompanyService.GetCompanyDetails:output_type -> company.GetCompanyDetailsRes
	13, // 25: company.CompanyService.GetCompanyEmployees:output_type -> company.GetCompanyEmployeesRes
	15, // 26: company.CompanyService.LogintoCompany:output_type -> company.LogintoCompanyRes
	12, // 27: company.CompanyService.SearchCompanies:output_type -> company.GetCompanyDetailsRes
	18, // 28: company.CompanyService.AddMemberStatus:output_type -> google.protobuf.Empty
