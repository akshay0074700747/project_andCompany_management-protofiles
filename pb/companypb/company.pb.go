...
var file_company_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x09, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x49, 0x44, 0x32, 0x88, 0x03,
	...
	0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x70, 0x62,
...
var file_company_proto_depIdxs = []int32{
	...
	7, // 2: company.AddEmployeeReq.Deadline:type_name -> google.protobuf.Timestamp
	1, // 3: company.CompanyService.RegisterCompany:input_type -> company.RegisterCompanyRequest
	8, // 4: company.CompanyService.GetCompanyTypes:input_type -> google.protobuf.Empty
	8, // 5: company.CompanyService.GetPermissions:input_type -> google.protobuf.Empty
	...
	3, // 8: company.CompanyService.RegisterCompany:output_type -> company.CompanyResponce
	2, // 9: company.CompanyService.GetCompanyTypes:output_type -> company.GetCompanyTypesRes
	4, // 10: company.CompanyService.GetPermissions:output_type -> company.Permission
	8, // 11: company.CompanyService.AddEmployees:output_type -> google.protobuf.Empty
	8, // 12: company.CompanyService.AttachRoleWithPermisssions:output_type -> google.protobuf.Empty
