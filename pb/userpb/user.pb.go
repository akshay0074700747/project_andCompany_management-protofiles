...
var file_user_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x32, 0xd6, 0x02,
...
var file_user_proto_depIdxs = []int32{
	...
	9, // 1: user.UserService.GetRoles:input_type -> google.protobuf.Empty
	...
	4, // 6: user.UserService.SignupUser:output_type -> user.UserResponce
	1, // 7: user.UserService.GetRoles:output_type -> user.Role
	9, // 8: user.UserService.SetStatus:output_type -> google.protobuf.Empty
	6, // 9: user.UserService.GetByEmail:output_type -> user.GetByEmailRes
	8, // 10: user.UserService.SearchforMembers:output_type -> user.SearchRes
	9, // 11: user.UserService.AddRoles:output_type -> google.protobuf.Empty
