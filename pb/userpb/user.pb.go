...
var file_user_proto_rawDesc = []byte{
	...
	0x42, 0x79, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x73, 0x42, 0x0d, 0x5a, 0x0b, 0x2e, 0x2f,
...
var file_user_proto_depIdxs = []int32{
	...
	3, // 4: user.UserService.SignupUser:output_type -> user.UserResponce
	1, // 5: user.UserService.GetRoles:output_type -> user.Role
	6, // 6: user.UserService.SetStatus:output_type -> google.protobuf.Empty
	5, // 7: user.UserService.GetByEmail:output_type -> user.GetByEmailRes
