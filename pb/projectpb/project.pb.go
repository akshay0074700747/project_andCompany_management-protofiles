...
var file_project_proto_rawDesc = []byte{
	...
	0x6a, 0x65, 0x63, 0x74, 0x55, 0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xa0, 0x0b, 0x0a,
	...
	0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x65, 0x73, 0x52, 0x65, 0x73, 0x28, 0x01, 0x30, 0x01, 0x42,
	0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x70, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x70,
...
var file_project_proto_depIdxs = []int32{
	...
	30, // 1: project.GetAssignedTaskRes.Deadline:type_name -> google.protobuf.Timestamp
	...
	1,  // 21: project.ProjectService.CreateProject:output_type -> project.CreateProjectRes
	31, // 22: project.ProjectService.AddMembers:output_type -> google.protobuf.Empty
	4,  // 23: project.ProjectService.ProjectInvites:output_type -> project.ProjectInvitesRes
	31, // 24: project.ProjectService.AcceptProjectInvite:output_type -> google.protobuf.Empty
	8,  // 25: project.ProjectService.GetProjectDetailes:output_type -> project.GetProjectDetailesRes
	7,  // 26: project.ProjectService.GetProjectMembers:output_type -> project.GetProjectMembersRes
	10, // 27: project.ProjectService.LogintoProject:output_type -> project.LogintoProjectRes
	31, // 28: project.ProjectService.AddMemberStatus:output_type -> google.protobuf.Empty
	13, // 29: project.ProjectService.GetAssignedTask:output_type -> project.GetAssignedTaskRes
	15, // 30: project.ProjectService.DownloadTask:output_type -> project.DownloadTaskRes
	17, // 31: project.ProjectService.GetProgressofMembers:output_type -> project.GetProgressofMembersRes
	18, // 32: project.ProjectService.GetProgressofMember:output_type -> project.GetProgressofMemberRes
	23, // 33: project.ProjectService.GetProjectProgress:output_type -> project.GetProjectProgressRes
	31, // 34: project.ProjectService.MarkProgressofNonTechnical:output_type -> google.protobuf.Empty
	31, // 35: project.ProjectService.AddTaskStatuses:output_type -> google.protobuf.Empty
	26, // 36: project.ProjectService.GetLiveProjects:output_type -> project.GetLiveProjectsRes
	31, // 37: project.ProjectService.IsMemberAccepted:output_type -> google.protobuf.Empty
	8,  // 38: project.ProjectService.GetStreamofProjectDetails:output_type -> project.GetProjectDetailesRes
