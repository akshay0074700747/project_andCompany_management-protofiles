...
func (x *CreateProject) GetProjectUsername() string {
	if x != nil {
...
func (x *CreateProject) GetAim() string {
	if x != nil {
		return x.Aim
	}
	return ""
...
func (x *CreateProject) GetIsCompanybased() bool {
	if x != nil {
...
func (x *CreateProject) GetComapanyId() string {
	if x != nil {
		return x.ComapanyId
	}
	return ""
...
var file_project_proto_rawDesc = []byte{
	...
	0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xc9, 0x01, 0x0a, 0x0d, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x69, 0x6d, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x61, 0x69, 0x6d, 0x12, 0x26, 0x0a, 0x0e, 0x69, 0x73, 0x43,
	0x6f, 0x6d, 0x70, 0x61, 0x6e, 0x79, 0x62, 0x61, 0x73, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x6f, 0x6d, 0x61, 0x70, 0x61, 0x6e, 0x79, 0x49,
	0x64, 0x42, 0x10, 0x5a, 0x0e, 0x2e, 0x2f, 0x70, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63,
...
var file_project_proto_goTypes = []interface{}{
	(*CreateProject)(nil), // 0: user.CreateProject
}
